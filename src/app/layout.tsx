    ...
    <html lang="pl">
      <body>
        <ThemeContextProvider>
          <div
            className={`${montserrat.className} flex flex-col items-center justify-between max-w-screen min-h-screen h-full bg-[var(--body-bg-light)] dark:bg-[var(--body-bg-dark)] text-black dark:text-white font-normal overflow-x-hidden`}
          >
